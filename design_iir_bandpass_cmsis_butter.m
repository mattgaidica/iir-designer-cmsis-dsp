...
function coeffs = design_iir_bandpass_cmsis_butter(requested_order, f1, f2, fs, plot_results)
...
[z,p,k] = butter(filtOrder,[f1 f2]/fNyquist, 'bandpass');
...
if (plot_results == true)
    iir_designer_plot(filtOrder, f1, f2, fs, 'bandpass_butter');
end
